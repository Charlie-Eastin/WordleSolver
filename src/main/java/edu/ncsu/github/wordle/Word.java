...
public class Word {
	...
	public Word(final int wordLength) {
		// Initialize the array to the specified length
		letters = new Letter[wordLength];

		final StringBuilder sb = new StringBuilder();
		for (int i = 0; i < wordLength; i++) {
			// Create a new Letter object for each position
	...
	public void setLetters(final String newWord) {
		// Update the string representation to the uppercase of the provided word
		...
		for (int i = 0; i < size; i++) {
			// Initialize each Letter with the corresponding character in the new word
